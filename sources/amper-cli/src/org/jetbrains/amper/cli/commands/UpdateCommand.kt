...
internal class UpdateCommand : AmperSubcommand(name = "update") {
    ...
    override fun help(context: Context): String = "Update Kargo to the latest version or a specific version."

    override fun helpEpilog(context: Context): String =
        "This command can also be used to create Kargo scripts in a directory if they don't exist yet."
