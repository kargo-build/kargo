...
| `output: string`               | `null`                                                  | Output directory or path for the final Executable JAR (used when running the `package` command).                                                                                                                                                                                                                                                                                                                                                       |
...
| `output: string`     | `dist/` | Output directory or path for the final distributable binary        |
