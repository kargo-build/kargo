---
description: |
  Migrate your Maven project to Kargo: run the semi-automated converter, understand the concept mapping, and learn
...
1. **Build and test.** Run `./kargo build` and `./kargo test` to verify the conversion.
